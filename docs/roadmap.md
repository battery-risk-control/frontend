...
- [x] Phase 11 — 구매팀 대시보드 2차 데모 재배치 (UX-01-DB, `youngjin/2nd-demo-layout` 브랜치, 2026-07-29)
  ...
  - 후속 3차(2026-08-02) — `feat/procurement-risk-kpi` push 후 CI에서 발견된
    `MaterialRiskStatusPanel`(브리핑 보기 링크) 부재를 Phase 11 재배치의 미완료 잔재로
    확인, 본문에 복귀. 전체 e2e 24개 통과 확인. 상세는 `docs/timeline.md` "Phase 11 후속
    3차" 참고.
