 ...
 * mock이 3종(니켈/리튬/코발트)인 것과 달리 실 API는 8종(멀티에이전트 MaterialCategory와 동일:
 * 리튬/니켈/코발트/망간/알루미늄/구리/흑연/희토류)을 내려주며, 화면의 "원자재" 드롭다운·요약
 * 카드는 데이터에서 자동 생성되므로 프론트 수정 없이 항목이 늘어난다.
 *
